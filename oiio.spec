...
Version  : 2.5.13.0
Release  : 57
URL      : https://github.com/OpenImageIO/oiio/archive/v2.5.13.0/oiio-2.5.13.0.tar.gz
Source0  : https://github.com/OpenImageIO/oiio/archive/v2.5.13.0/oiio-2.5.13.0.tar.gz
...
%prep
%setup -q -n OpenImageIO-2.5.13.0
cd %{_builddir}/OpenImageIO-2.5.13.0
pushd ..
cp -a OpenImageIO-2.5.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720129773
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
