...
%prep
%setup -q -n OpenImageIO-2.5.10.1
cd %{_builddir}/OpenImageIO-2.5.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718860027
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOpenImageIO.so.2.5.10
/V3/usr/lib64/libOpenImageIO_Util.so.2.5.10
/usr/lib64/libOpenImageIO.so.2.5
/usr/lib64/libOpenImageIO.so.2.5.10
/usr/lib64/libOpenImageIO_Util.so.2.5
/usr/lib64/libOpenImageIO_Util.so.2.5.10
