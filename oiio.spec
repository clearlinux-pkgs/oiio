...
Version  : 2.2.15.0
Release  : 30
URL      : https://github.com/OpenImageIO/oiio/archive/Release-2.2.15.0/oiio-2.2.15.0.tar.gz
Source0  : https://github.com/OpenImageIO/oiio/archive/Release-2.2.15.0/oiio-2.2.15.0.tar.gz
...
%prep
%setup -q -n oiio-Release-2.2.15.0
cd %{_builddir}/oiio-Release-2.2.15.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622742835
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oiio-Release-2.2.15.0/LICENSE.md %{buildroot}/usr/share/package-licenses/oiio/8753cb3fb20c55b0a920e1fbc7d9be770f2be3c6
cp %{_builddir}/oiio-Release-2.2.15.0/src/fonts/Droid_Sans/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.15.0/src/fonts/Droid_Sans_Mono/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.15.0/src/fonts/Droid_Serif/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
