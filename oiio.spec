...
cmake .. -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=/usr -DBUILD_SHARED_LIBS:BOOL=ON -DLIB_INSTALL_DIR:PATH=/usr/lib64 -DCMAKE_AR=/usr/bin/gcc-ar -DLIB_SUFFIX=64 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_RANLIB=/usr/bin/gcc-ranlib -DSTOP_ON_WARNING=OFF -DILMBASE_INCLUDE_PATH=/usr/include/OpenEXR
...
/usr/share/fonts/oiio/DroidSans-Bold.ttf
/usr/share/fonts/oiio/DroidSans.ttf
/usr/share/fonts/oiio/DroidSansMono.ttf
/usr/share/fonts/oiio/DroidSerif-Bold.ttf
/usr/share/fonts/oiio/DroidSerif-BoldItalic.ttf
/usr/share/fonts/oiio/DroidSerif-Italic.ttf
/usr/share/fonts/oiio/DroidSerif.ttf
...
/usr/include/OpenImageIO/coordinate.h
...
%files lib
%defattr(-,root,root,-)
/usr/lib/python/site-packages/OpenImageIO.so
/usr/lib64/libOpenImageIO.so.1.7
/usr/lib64/libOpenImageIO.so.1.7.16
/usr/lib64/libOpenImageIO_Util.so.1.7
/usr/lib64/libOpenImageIO_Util.so.1.7.16
