...
Source0  : https://github.com/OpenImageIO/oiio/archive/Release-2.2.11.1/oiio-2.2.11.1.tar.gz
...
%prep
%setup -q -n oiio-Release-2.2.11.1
cd %{_builddir}/oiio-Release-2.2.11.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614623889
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oiio-Release-2.2.11.1/LICENSE.md %{buildroot}/usr/share/package-licenses/oiio/8753cb3fb20c55b0a920e1fbc7d9be770f2be3c6
cp %{_builddir}/oiio-Release-2.2.11.1/src/fonts/Droid_Sans/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.11.1/src/fonts/Droid_Sans_Mono/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.11.1/src/fonts/Droid_Serif/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
...
/usr/lib64/libOpenImageIO.so.2.2.11
/usr/lib64/libOpenImageIO_Util.so.2.2
/usr/lib64/libOpenImageIO_Util.so.2.2.11
