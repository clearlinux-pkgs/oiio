...
%prep
%setup -q -n OpenImageIO-2.4.6.1
cd %{_builddir}/OpenImageIO-2.4.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701465587
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/OpenImageIO-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/oiio/ed2d01d8d15c106c1a00da431acc00882046f3e7 || :
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build
