...
Source0  : https://github.com/OpenImageIO/oiio/archive/v3.0.4.0/oiio-3.0.4.0.tar.gz
...
%prep
%setup -q -n OpenImageIO-3.0.4.0
cd %{_builddir}/OpenImageIO-3.0.4.0
pushd ..
cp -a OpenImageIO-3.0.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742444589
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOpenImageIO.so.3.0.4
/V3/usr/lib64/libOpenImageIO_Util.so.3.0.4
/usr/lib64/libOpenImageIO.so.3.0
/usr/lib64/libOpenImageIO.so.3.0.4
/usr/lib64/libOpenImageIO_Util.so.3.0
/usr/lib64/libOpenImageIO_Util.so.3.0.4
