...
%prep
%setup -q -n oiio-2.3.19.0
cd %{_builddir}/oiio-2.3.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663393432
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libOpenImageIO.so.2.3.19
/usr/lib64/libOpenImageIO_Util.so.2.3
/usr/lib64/libOpenImageIO_Util.so.2.3.19
