...
Version  : 3.0.5.0
Release  : 66
URL      : https://github.com/OpenImageIO/oiio/archive/v3.0.5.0/oiio-3.0.5.0.tar.gz
Source0  : https://github.com/OpenImageIO/oiio/archive/v3.0.5.0/oiio-3.0.5.0.tar.gz
...
%prep
%setup -q -n OpenImageIO-3.0.5.0
cd %{_builddir}/OpenImageIO-3.0.5.0
pushd ..
cp -a OpenImageIO-3.0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743637467
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOpenImageIO.so.3.0.5
/V3/usr/lib64/libOpenImageIO_Util.so.3.0.5
/usr/lib64/libOpenImageIO.so.3.0
/usr/lib64/libOpenImageIO.so.3.0.5
/usr/lib64/libOpenImageIO_Util.so.3.0
/usr/lib64/libOpenImageIO_Util.so.3.0.5
