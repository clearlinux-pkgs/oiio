...
Source0  : https://github.com/OpenImageIO/oiio/archive/Release-1.8.15.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540772864
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libOpenImageIO.so.1.8.15
/usr/lib64/libOpenImageIO_Util.so.1.8
/usr/lib64/libOpenImageIO_Util.so.1.8.15
