...
%prep
%setup -q -n oiio-Release-2.2.14.0
cd %{_builddir}/oiio-Release-2.2.14.0
...
cp %{_builddir}/oiio-Release-2.2.14.0/src/fonts/Droid_Sans/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.14.0/src/fonts/Droid_Sans_Mono/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/oiio-Release-2.2.14.0/src/fonts/Droid_Serif/LICENSE.txt %{buildroot}/usr/share/package-licenses/oiio/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build
%make_install
popd
...
/usr/lib64/libOpenImageIO.so.2.2.14
/usr/lib64/libOpenImageIO_Util.so.2.2
/usr/lib64/libOpenImageIO_Util.so.2.2.14
