...
Source0  : https://github.com/OpenImageIO/oiio/archive/v3.0.6.1/oiio-3.0.6.1.tar.gz
...
%prep
%setup -q -n OpenImageIO-3.0.6.1
cd %{_builddir}/OpenImageIO-3.0.6.1
pushd ..
cp -a OpenImageIO-3.0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746463854
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/include/OpenImageIO/span_util.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libOpenImageIO.so.3.0.6
/V3/usr/lib64/libOpenImageIO_Util.so.3.0.6
/usr/lib64/libOpenImageIO.so.3.0
/usr/lib64/libOpenImageIO.so.3.0.6
/usr/lib64/libOpenImageIO_Util.so.3.0
/usr/lib64/libOpenImageIO_Util.so.3.0.6
