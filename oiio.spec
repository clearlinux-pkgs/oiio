...
Version  : 2.3.16.0
Release  : 38
URL      : https://github.com/OpenImageIO/oiio/archive/v2.3.16.0/oiio-2.3.16.0.tar.gz
Source0  : https://github.com/OpenImageIO/oiio/archive/v2.3.16.0/oiio-2.3.16.0.tar.gz
...
%prep
%setup -q -n oiio-2.3.16.0
cd %{_builddir}/oiio-2.3.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654718146
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oiio-2.3.16.0/LICENSE.md %{buildroot}/usr/share/package-licenses/oiio/ed2d01d8d15c106c1a00da431acc00882046f3e7
pushd clr-build
%make_install
popd
...
/usr/include/OpenImageIO/c-deepdata.h
/usr/include/OpenImageIO/c-paramlist.h
/usr/include/OpenImageIO/c-typedesc.h
...
/usr/lib64/libOpenImageIO.so.2.3.16
/usr/lib64/libOpenImageIO_Util.so.2.3
/usr/lib64/libOpenImageIO_Util.so.2.3.16
